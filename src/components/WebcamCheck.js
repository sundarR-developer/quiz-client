  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-xl bg-white rounded shadow-md p-8">
        <h1 className="text-2xl font-bold mb-6 text-center text-gray-900 border-2 border-green-400 rounded p-2">Webcam & Microphone Check</h1>
        <div className="bg-gray-100 rounded p-6 text-center">
          ...
          {isCameraOn && (
            <>
              <p className="text-green-700 mb-4">Your camera and microphone are active. The exam will be proctored.</p>
              <div className="pt-4">
                <button onClick={onVerified} className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition font-semibold">
                  Start Exam
                </button>
              </div>
            </>
